  ...
  return (
    <div className="page">
      <div className="page__content-wrapper">
        <h2 className="page__h2">About Meal Planner</h2>
        <p>
        ...
        <h2 className="page__h2">Disclaimer</h2>
        <p>
          ...
          are not guaranteed to be accurate. If you suffer from food allergies
          or intolerances, please make sure to double-check the ingredients list
          on the package you purchased and do not rely solely on our data.
        </p>
      </div>
    </div>
  );
